...
native = Path('artifacts/bin/native/net9.0-libnx-Release-arm64')
...
manifest = {
    'format': 1, 'target': 'libnx-arm64', 'runtime_version': '9.0.3',
    'source_revision': revision, 'gc': 'workstation',
    'ilc_version': '9.0.3', 'application_sdk_tested': '10.0.111',
...
(output/'README.md').write_text('''# Experimental Horizon NativeAOT SDK

This package contains the source-built .NET 9.0.3 workstation runtime, native
BCL, five Horizon SDK assemblies, and the Horizon socket assembly. It contains
...
Use ILC 9.0.3, the five SDK DLLs together, --noinlinetls, the included Horizon
