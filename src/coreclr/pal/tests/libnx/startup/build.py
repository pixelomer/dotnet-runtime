...
output = repo / 'artifacts/libnx-coreclr-startup'
...
target = output / 'coreclr-startup-probe'
...
subprocess.run([str(devkitpro / 'tools/bin/nacptool'), '--create', 'CoreCLR native startup',
